---
title: html5 canvas 实现的小画板
date: 2016-08-27 14:30:05
tags: html5
---
### 代码如下
<!--more-->
lineTo() stroke()方法实现画画功能,设置globalCompositeOperation = "destination-out"(像素合成方式)实现橡皮擦功能,getImageData() putImageData()实现撤消功能,代码如下:  
```html
<!DOCTYPE html>
<html lang="en">
<head>
